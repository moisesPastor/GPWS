...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.labelX, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelNombreImg, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.barProb, 2, 0, 1, 3)
